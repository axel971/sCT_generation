...
# python .\data_downloading.py -url "https://zenodo.org/records/7260705/files/Task1.zip?download=1" -data_file_name "task1.zip" -data_dir "C:\Users\axell\Documents\dev\sCT_generation\data\raw_data"
...
def main(url: str,
    ...
    with open(DATA_DIR/data_file_name, "wb") as f:
...
if __name__ == "__main__":
    ...
    main(url = args.url, data_file_name = args.data_file_name, data_dir = args.data_dir)
