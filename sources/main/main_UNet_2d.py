# -patient_list_path = "C:\Users\axell\Documents\dev\sCT_generation\data\patients_list.xlsx" 
...
def main(patient_list_path: str,
         mri_dir: str,
         ct_dir: str,
         sct_dir: str,
         img_ext: str):

    patient_list = pd.read_excel(patient_list_path, header = 0, index_col = 0)["patient_name"].to_numpy()
    ...
    training_mris, testing_mris, training_cts, testing_cts, training_patient_list, testing_patient_list = train_test_split(mris, cts,patient_list, test_size = 0.30, random_state = 42)
    ...
    for iPatient in range(len(training_patient_list)):
    ...
    for iPatient in range(len(testing_patient_list)):
...
if __name__ == "__main__":
    ...
    parser.add_argument("-patient_list_path", required = True, help = "Path toward the excel file containing the patients name")
    ...
    main(patient_list_path = args.patient_list_path,
